...
import com.tojava.myapp.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/vuehipster-01-kafka")
public class Vuehipster01KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Vuehipster01KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public Vuehipster01KafkaResource(KafkaProperties kafkaProperties) {
